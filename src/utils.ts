...
export function fetchCollateralSymbol(address: Address): string {
  ...
  // eth_call cannot use for arbitrum-one now.
  if (addressStr == '0xff970a61a04b1ca14834a43f5de4533ebddb5cc8') {
      return 'USDC'
  } else if (addressStr == '0x82af49447d8a07e3bd95bd0d56f35241523fbab1') {
      return 'WETH'
...
export function fetchOracleUnderlying(address: Address): string {
  let addressStr = address.toHexString()
  // eth_call cannot use for arbitrum-one now.
  if (addressStr == '0x1cf22b7f84f86c36cb191bb24993eda2b191399e') {
      return 'ETH'
  } else if (addressStr == '0x6ee936bdbd329063e8ce1d13f42efef912e85221') {
      return 'BTC'
  } else {
    return "Unknown"
  }
